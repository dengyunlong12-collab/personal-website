...
interface Props {
  records: DanceRecord[]
  onEdit: (record: DanceRecord) => void
  onDelete: (id: string) => void
}

export default function DanceRecordList({ records, onEdit, onDelete }: Props) {
  if (records.length === 0) {
    return (
      <div className="text-center py-16">
        <p className="text-gray-400 text-sm">No dance records yet. Let the rhythm move you!</p>
      </div>
    )
  }
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h4 className="text-base font-semibold text-gray-900">{record.dance_style}</h4>
