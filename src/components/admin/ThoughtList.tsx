...
interface Props {
  ...
  onEdit: (record: DailyThought) => void
  onDelete: (id: string) => void
}

export default function ThoughtList({ records, onEdit, onDelete }: Props) {
  if (records.length === 0) {
    return (
      <div className="text-center py-16">
        <p className="text-gray-400 text-sm">No thoughts recorded yet. What's on your mind?</p>
      </div>
    )
  }
