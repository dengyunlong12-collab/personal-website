  ...
  if (records.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-400 text-sm">No fitness records to show yet.</p>
      </div>
    )
  }
    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-12 animate-fade-in-up">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 text-center">
          ...
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide font-medium">Sessions</p>
        </div>
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 text-center">
          <p className="text-3xl font-bold text-gray-900 tracking-tight">{totalMinutes}</p>
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide font-medium">Minutes</p>
        </div>
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 text-center">
          ...
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide font-medium">Activities</p>
        </div>
      </div>
